    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input name="kode_jurusan" value="<?= $jurusan['kode_jurusan']; ?>" class="form-control"> </input>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Jurusan</label>
                        <input name="jurusan" value="<?= $jurusan['jurusan']; ?>" class="form-control"> </input>
            ...
            <div class="form-group">
                ...
                <textarea name="visi_misi" id="summernote"> <?= $jurusan['visimisi']; ?></textarea>
            </div>
        </div>
