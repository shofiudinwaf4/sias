         ...
         <div class="row course-slied mt-30">
             <div class="col-lg-4">
                 <div class="singel-course">
                     <div class="thum">
                         <div class="image">
                             <img src="<?= base_url('edubin'); ?>/images/course/cu-1.jpg" alt="Course">
                         </div>
                         <div class="price">
                             <span>Free</span>
                         </div>
                     ...
                     <div class="cont">
                         ...
                         <div class="course-teacher">
                             <div class="thum">
                                 <a href="#"><img src="<?= base_url('edubin'); ?>/images/course/teacher/t-1.jpg" alt="teacher"></a>
                             </div>
                             <div class="name">
                                 <a href="#">
                                     <h6>Mark anthem</h6>
             ...
             <div class="col-lg-4">
                 <div class="singel-course">
                     <div class="thum">
                         <div class="image">
                             <img src="<?= base_url('edubin'); ?>/images/course/cu-2.jpg" alt="Course">
                         </div>
                         <div class="price">
                             <span>Free</span>
                         </div>
             ...
             <div class="col-lg-4">
                 <div class="singel-course">
                     <div class="thum">
                         <div class="image">
                             <img src="<?= base_url('edubin'); ?>/images/course/cu-3.jpg" alt="Course">
                         </div>
                         <div class="price">
                             <span>Free</span>
                         </div>
                     ...
                     <div class="cont">
                         ...
                         <div class="course-teacher">
                             <div class="thum">
                                 <a href="#"><img src="<?= base_url('edubin'); ?>/images/course/teacher/t-3.jpg" alt="teacher"></a>
                             </div>
                             <div class="name">
                                 <a href="#">
                                     <h6>Mark anthem</h6>
             ...
             <div class="col-lg-4">
                 <div class="singel-course">
                     <div class="thum">
                         <div class="image">
                             <img src="<?= base_url('edubin'); ?>/images/course/cu-4.jpg" alt="Course">
                         </div>
                         <div class="price">
                             <span>Free</span>
                         </div>
                     ...
                     <div class="cont">
                         ...
                         <div class="course-teacher">
                             <div class="thum">
                                 <a href="#"><img src="<?= base_url('edubin'); ?>/images/course/teacher/t-4.jpg" alt="teacher"></a>
                             </div>
                             <div class="name">
                                 <a href="#">
                                     <h6>Mark anthem</h6>
             ...
             <div class="col-lg-4">
                 <div class="singel-course">
                     <div class="thum">
                         <div class="image">
                             <img src="<?= base_url('edubin'); ?>/images/course/cu-5.jpg" alt="Course">
                         </div>
                         <div class="price">
                             <span>Free</span>
                         </div>
                     ...
                     <div class="cont">
                         ...
                         <div class="course-teacher">
                             <div class="thum">
                                 <a href="#"><img src="<?= base_url('edubin'); ?>/images/course/teacher/t-5.jpg" alt="teacher"></a>
                             </div>
                             <div class="name">
                                 <a href="#">
                                     <h6>Mark anthem</h6>
                     ...
                     <ul>
                         <li>
                             <div class="singel-feature">
                                 <div class="icon">
                                     <img src="<?= base_url('edubin'); ?>/images/all-icon/f-1.png" alt="icon">
                                 </div>
                                 <div class="cont">
                         ...
                         <li>
                             <div class="singel-feature">
                                 <div class="icon">
                                     <img src="<?= base_url('edubin'); ?>/images/all-icon/f-2.png" alt="icon">
                                 </div>
                                 <div class="cont">
                         ...
                         <li>
                             <div class="singel-feature">
                                 <div class="icon">
                                     <img src="<?= base_url('edubin'); ?>/images/all-icon/f-3.png" alt="icon">
                                 </div>
                                 <div class="cont">
                                     <h4>Books & Library</h4>
                                     <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem sem quibibendum sem nibhutis.</p>
                     ...
                     <div class="row">
                         <div class="col-sm-6">
                             <div class="singel-teachers mt-30 text-center">
                                 <div class="image">
                                     <img src="<?= base_url('edubin'); ?>/images/teachers/t-1.jpg" alt="Teachers">
                                 </div>
                                 <div class="cont">
                         ...
                         <div class="col-sm-6">
                             <div class="singel-teachers mt-30 text-center">
                                 <div class="image">
                                     <img src="<?= base_url('edubin'); ?>/images/teachers/t-2.jpg" alt="Teachers">
                                 </div>
                                 <div class="cont">
                                     <a href="teachers-singel.html">
                                         <h6>David card</h6>
                         ...
                         <div class="col-sm-6">
                             <div class="singel-teachers mt-30 text-center">
                                 <div class="image">
                                     <img src="<?= base_url('edubin'); ?>/images/teachers/t-3.jpg" alt="Teachers">
                                 </div>
                                 <div class="cont">
                                     <a href="teachers-singel.html">
                                         <h6>Rebeka alig</h6>
                         ...
                         <div class="col-sm-6">
                             <div class="singel-teachers mt-30 text-center">
                                 <div class="image">
                                     <img src="<?= base_url('edubin'); ?>/images/teachers/t-4.jpg" alt="Teachers">
                                 </div>
                                 <div class="cont">
                                     <a href="teachers-singel.html">
                                         <h6>Hanna bein</h6>
         ...
         <div class="row justify-content-center">
             <div class="col-lg-3 col-md-6 col-sm-8">
                 <div class="singel-publication mt-30">
                     <div class="image">
                         <img src="<?= base_url('edubin'); ?>/images/publication/p-1.jpg" alt="Publication">
                         <div class="add-cart">
                             <ul>
             ...
             <div class="col-lg-3 col-md-6 col-sm-8">
                 <div class="singel-publication mt-30">
                     <div class="image">
                         <img src="<?= base_url('edubin'); ?>/images/publication/p-2.jpg" alt="Publication">
                         <div class="add-cart">
                             <ul>
                                 <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                 <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
             ...
             <div class="col-lg-3 col-md-6 col-sm-8">
                 <div class="singel-publication mt-30">
                     <div class="image">
                         <img src="<?= base_url('edubin'); ?>/images/publication/p-3.jpg" alt="Publication">
                         <div class="add-cart">
                             <ul>
                                 <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                 <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
             ...
             <div class="col-lg-3 col-md-6 col-sm-8">
                 <div class="singel-publication mt-30">
                     <div class="image">
                         <img src="<?= base_url('edubin'); ?>/images/publication/p-4.jpg" alt="Publication">
                         <div class="add-cart">
                             <ul>
                                 <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                 <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
     ...
     <div class="container">
         ...
         <div class="row testimonial-slied mt-40">
             <div class="col-lg-6">
                 <div class="singel-testimonial">
                     <div class="testimonial-thum">
                         <img src="<?= base_url('edubin'); ?>/images/testimonial/t-1.jpg" alt="Testimonial">
                         <div class="quote">
             ...
             <div class="col-lg-6">
                 <div class="singel-testimonial">
                     <div class="testimonial-thum">
                         <img src="<?= base_url('edubin'); ?>/images/testimonial/t-2.jpg" alt="Testimonial">
                         <div class="quote">
                             <i class="fa fa-quote-right"></i>
                         </div>
                     </div>
             ...
             <div class="col-lg-6">
                 <div class="singel-testimonial">
                     <div class="testimonial-thum">
                         <img src="<?= base_url('edubin'); ?>/images/testimonial/t-3.jpg" alt="Testimonial">
                         <div class="quote">
                             <i class="fa fa-quote-right"></i>
                         </div>
                     </div>
             ...
             <div class="col-lg-6">
                 <div class="singel-news mt-30">
                     <div class="news-thum pb-25">
                         <img src="<?= base_url('edubin'); ?>/images/news/n-1.jpg" alt="News">
                     </div>
                     <div class="news-cont">
                         <ul>
             ...
             <div class="col-lg-6">
                     ...
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="news-thum mt-30">
                                 <img src="<?= base_url('edubin'); ?>/images/news/ns-1.jpg" alt="News">
                             </div>
                         </div>
                         <div class="col-sm-8">
                 ...
                 <div class="singel-news news-list">
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="news-thum mt-30">
                                 <img src="<?= base_url('edubin'); ?>/images/news/ns-2.jpg" alt="News">
                             </div>
                         </div>
                         <div class="col-sm-8">
                             <div class="news-cont mt-30">
                 ...
                 <div class="singel-news news-list">
                     <div class="row">
                         <div class="col-sm-4">
                             <div class="news-thum mt-30">
                                 <img src="<?= base_url('edubin'); ?>/images/news/ns-3.jpg" alt="News">
                             </div>
                         </div>
                         <div class="col-sm-8">
                             <div class="news-cont mt-30">
